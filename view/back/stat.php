...
<body>
            ...
            <div class="col-lg-12 grid-margin grid-margin-lg-0 stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  <h4 class="card-title">statistiques sur les prix des services </h4>
                  <canvas id="pieChart" width="1061" height="530" style="display: block; height: 424px; width: 849px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
  ...
  <script>
    $(function() {
      ...
      var newData = [<?php echo $min; ?>, <?php echo $med; ?>, <?php echo $max; ?>];
