...
<body>
    ...
    <script>
      function search() {
          ...
          window.location.href = 'recherchefr.php?tt=' + encodeURIComponent(tt);
      }
  </script>
    <!-- Package Start -->
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                ...
                <h1 class="mb-5">Services magnefique</h1>
            </div>
            <div class="position-relative mx-auto" style="max-width: 400px;">
                        <input name="tt" class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" placeholder="recherche par le  nom du service ">
                        <button  type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2" onclick="search()">recherche</button>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <div class="package-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="../back/<?php echo $aff["photo"];?>" alt="">
                        </div>
                        <div class="d-flex border-bottom">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo $aff["nom"];?></small>
                            
                        </div>
                        <div class="text-center p-4">
                            <h3 class="mb-0"><?php echo $aff["prix"];?> <strong>DT</strong></h3>
                            <div class="mb-3">
                            ...
                            <p>disponible jusqu'a : <?php echo $aff["date"];?></p>
                            <div class="d-flex justify-content-center mb-1">
                               
                                <a href="excru.php?ids=<?php echo $aff['ids']; ?>" class="btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Excurse ?</a>
                            </div>
                        </div>
                    </div>
                </div>
